...
//! un `mod` sous `scribe` : les fonctions couvertes sont `pub(crate)`, donc
//! invisibles depuis un crate de test externe. Ce module porte le décor commun,
//! ses sous-modules les tests d'un même sujet.
//!
